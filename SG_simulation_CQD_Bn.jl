...
ki = 0.75e-6;
@time CQD_up_particles_flag         = TheoreticalSimulation.CQD_Bn_flag_travelling_particles(Icoils, data_UP, ki, K39_params; y_length=5001,verbose=true);
@time CQD_up_particles_trajectories = TheoreticalSimulation.CQD_Bn_build_travelling_particles(Icoils, ki, data_UP, CQD_up_particles_flag, K39_params);     # [x0 y0 z0 vx0 vy0 vz0 θe θn x z vz]
@time CQD_dw_particles_flag         = TheoreticalSimulation.CQD_Bn_flag_travelling_particles(Icoils, data_DOWN, ki, K39_params; y_length=5001,verbose=true);
@time CQD_dw_particles_trajectories = TheoreticalSimulation.CQD_Bn_build_travelling_particles(Icoils, ki, data_DOWN, CQD_dw_particles_flag, K39_params);   # [x0 y0 z0 vx0 vy0 vz0 θe θn x z vz]

TheoreticalSimulation.CQD_Bn_travelling_particles_summary(Icoils,CQD_up_particles_trajectories, :up)
TheoreticalSimulation.CQD_Bn_travelling_particles_summary(Icoils,CQD_dw_particles_trajectories, :down)

CQD_up_screen = OrderedDict(:Icoils=>Icoils, :data => TheoreticalSimulation.CQD_Bn_select_flagged(CQD_up_particles_trajectories,:screen ))
CQD_dw_screen = OrderedDict(:Icoils=>Icoils, :data => TheoreticalSimulation.CQD_Bn_select_flagged(CQD_dw_particles_trajectories,:screen ))
...
anim = @animate for j in iter
    ...
    for i in axes(data_set,1)
        v0y = data_set[i,5]
        r , _ = TheoreticalSimulation.CQD_Bn_EqOfMotion(y_FurnaceToSlit ./ v0y, Icoils[j], μₑ, data_set[i,1:3], data_set[i,4:6], data_set[i,7], data_set[i,8], ki, K39_params)
        r_at_slit[i,:] = r
    end
    ...
    for i in axes(data_set,1)
        v0y = data_set[i,5]
        r , _ = TheoreticalSimulation.CQD_Bn_EqOfMotion((y_FurnaceToSlit+y_SlitToSG) ./ v0y , Icoils[j], μₑ, data_set[i,1:3], data_set[i,4:6], data_set[i,7], data_set[i,8], ki, K39_params)
    ...
    for i in axes(data_set,1)
        v0y = data_set[i,5]
        r , _ = TheoreticalSimulation.CQD_Bn_EqOfMotion((y_FurnaceToSlit+y_SlitToSG+y_SlitToSG) ./ v0y, Icoils[j], μₑ, data_set[i,1:3], data_set[i,4:6], data_set[i,7], data_set[i,8], ki, K39_params)
        r_at_SG_exit[i,:] = r
    end
    ...
    for i in axes(data_set,1)
        v0y = data_set[i,5]
        r , _ = TheoreticalSimulation.CQD_Bn_EqOfMotion((y_FurnaceToSlit+y_SlitToSG+y_SlitToSG+y_SGToScreen) ./ v0y, Icoils[j], μₑ, data_set[i,1:3], data_set[i,4:6], data_set[i,7], data_set[i,8], ki, K39_params)
        r_at_screen[i,:] = r
    end
...
for (i,ki) in enumerate(kis)
    ...
    @time temp_CQD_up_particles_flag         = TheoreticalSimulation.CQD_Bn_flag_travelling_particles(Icoils, data_UP, ki, K39_params; y_length=5001,verbose=true);
    @time temp_CQD_up_particles_trajectories = TheoreticalSimulation.CQD_Bn_build_travelling_particles(Icoils, ki, data_UP, temp_CQD_up_particles_flag, K39_params)      # [x0 y0 z0 vx0 vy0 vz0 θe θn x z vz]
    @time temp_CQD_dw_particles_flag         = TheoreticalSimulation.CQD_Bn_flag_travelling_particles(Icoils, data_DOWN, ki, K39_params; y_length=5001,verbose=true);
    @time temp_CQD_dw_particles_trajectories = TheoreticalSimulation.CQD_Bn_build_travelling_particles(Icoils, ki, data_DOWN, temp_CQD_dw_particles_flag, K39_params);   # [x0 y0 z0 vx0 vy0 vz0 θe θn x z vz]

    TheoreticalSimulation.CQD_Bn_travelling_particles_summary(Icoils,temp_CQD_up_particles_trajectories, :up)
    TheoreticalSimulation.CQD_Bn_travelling_particles_summary(Icoils,temp_CQD_dw_particles_trajectories, :down)
    ...
    jldsave(joinpath(OUTDIR,"cqd_Bn_$(Nss)_ki$(@sprintf("%02d", i))_up_screen.jld2"), screen=CQD_up_screen)
    jldsave(joinpath(OUTDIR,"cqd_Bn_$(Nss)_ki$(@sprintf("%02d", i))_dw_screen.jld2"), screen=CQD_dw_screen )
...
EXPERIMENT
    ...
    CO–QUANTUM DYNAMICS SIMULATION [ B₀ + Bₙ cos(θₙ) ]
    atom                    : $(atom)
